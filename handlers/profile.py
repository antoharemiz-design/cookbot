...
@router.message(ProfileForm.name, F.text, flags={"stop_propagation": True})
...
@router.message(ProfileForm.diet, F.text, flags={"stop_propagation": True})
...
@router.message(ProfileForm.allergies, F.text, flags={"stop_propagation": True})
...
@router.message(ProfileForm.dislikes, F.text, flags={"stop_propagation": True})
...
@router.message(ProfileForm.skill, F.text, flags={"stop_propagation": True})
